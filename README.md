...
3. Create spatially-interpolated snow depth maps
  ...
  7. ***IMPORTANT*** : In line 6 of `QGIS_Snow_Depth_Renderer.py`, you will need to specify **your own path** to the GitHub repository housing the Daily-Snow-Depth files.
